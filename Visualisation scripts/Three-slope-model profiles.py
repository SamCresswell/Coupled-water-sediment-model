...
if case_to_display == 1:
    
    hyp_conc = 0
    save_file_path = r"../Results/Graphical results/Three_slope_model.png"
    ...
    ds_y_lower_lim, ds_y_upper_lim = -3.5,6
...
elif case_to_display == 2:
    
    hyp_conc = 4
    save_file_path = r"../Results/Graphical results/Three_slope_model_4%.png"
    ups_x_lower_lim, ups_x_upper_lim = 0,1000
    gst_x_lower_lim, gst_x_upper_lim = 24000, 38000
    ds_x_lower_lim, ds_x_upper_lim = 45000, 50000
    ups_y_lower_lim, ups_y_upper_lim = 76.5, 79.5
    gst_y_lower_lim, gst_y_upper_lim = 10, 29
    ds_y_lower_lim, ds_y_upper_lim = -11,6
    text_pos_ups_x, text_pos_ups_y = 5000, 78
    text_pos_gst_x, text_pos_gst_y = 30000, 6
    text_pos_ds_x, text_pos_ds_y = 46000, 12
    lower_x_lim = 0
    upper_x_lim = 50000
    lower_y_lim = -11
...
elif case_to_display == 3:
    
    hyp_conc = 8
    save_file_path = r"../Results/Graphical results/Three_slope_model_8%.png"
    ups_x_lower_lim, ups_x_upper_lim = 0,1000
    gst_x_lower_lim, gst_x_upper_lim = 24000, 38000
    ds_x_lower_lim, ds_x_upper_lim = 45000, 50000
    ups_y_lower_lim, ups_y_upper_lim = 76.5, 78.5
    gst_y_lower_lim, gst_y_upper_lim = 10, 29
...
elif case_to_display == 4:
    
    hyp_conc = 12
    save_file_path = r"../Results/Graphical results/Three_slope_model_12%.png"
    ups_x_lower_lim, ups_x_upper_lim = 0,1000
    gst_x_lower_lim, gst_x_upper_lim = 24000, 38000
    ds_x_lower_lim, ds_x_upper_lim = 45000, 50000
    ups_y_lower_lim, ups_y_upper_lim = 76, 79
    gst_y_lower_lim, gst_y_upper_lim = 10, 29
    ds_y_lower_lim, ds_y_upper_lim = 0,6
    text_pos_ups_x, text_pos_ups_y = 5000, 78
    text_pos_gst_x, text_pos_gst_y = 30000, 7
    text_pos_ds_x, text_pos_ds_y = 46000, 12
    lower_x_lim = 0
    upper_x_lim = 50000
    lower_y_lim = -11
...
for index, row in other_rows_values.iterrows():
    ...
    if int(df1.iloc[index, 1]) == hyp_conc:

        color = colormapping5.get(int(df1.iloc[index, 0]))
        
        big_subplot.plot(first_row_values, row, label = df1.iloc[index, 0],linewidth = line_width, color = color)
...
big_subplot.set_ylabel('Elevation $z_b$ (m)',fontsize=axistitlesize*scalefactor)
ax1.set_xlabel('Horizontal position $x$ (m)',fontsize=axistitlesize*scalefactor)
ax1.set_ylabel('Elevation $z_b$ (m)',fontsize=axistitlesize*scalefactor)
ax2.set_xlabel('Horizontal position $x$ (m)',fontsize=axistitlesize*scalefactor)
ax2.set_ylabel('Elevation $z_b$ (m)',fontsize=axistitlesize*scalefactor)
ax3.set_xlabel('Horizontal position $x$ (m)',fontsize=axistitlesize*scalefactor)
ax3.set_ylabel('Elevation $z_b$ (m)',fontsize=axistitlesize*scalefactor)
...
fig.legend(fontsize = legendsize * scalefactor, loc='upper center', title='                                           Bed elevation $z_b$ after running flood of flowrate $q_{peak}$ (m$^2$s$^{-1}$)):',title_fontsize= legendtitlesize * scalefactor,frameon=False, ncol=ncols,bbox_to_anchor=(0.5, 1.0))#, bbox_to_anchor=(0.5, -0.03))
